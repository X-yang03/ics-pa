...
opcode_entry opcode_table [512] = {
  ...
  /* 0x20 */	IDEX(mov_load_cr,mov), EMPTY, IDEX(mov_E2G,mov_store_cr), EMPTY,
  ...
  /* 0xac */	IDEX(Ib_G2E, shrd), IDEX(Ib_G2E, shrd), EMPTY, IDEX(E2G,imul2),
  ...
  /* 0xf8 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xfc */	EMPTY, EMPTY, IDEXW(E, dec, 1), EMPTY
};
